...
public interface IFeatureInstallManager {
	 ...
	 * 
	 * @return IVersionedId[] the installed features. May be <code>null</code>
	 *         if some unexpected error occurs (e.g. the repository manager
	 *         service is not running on the target system being managed).
	 */
	 ...
	 *            features.
	 * 
	 * @return IVersionedId[] the installable features exposed at the repository
